...
module Crest
  ...
  class Request
    ...
    @connect_timeout : Int32 | Float32 | Time::Span | Nil
    @write_timeout : Int32 | Float32 | Time::Span | Nil
    @read_timeout : Int32 | Float32 | Time::Span | Nil
    ...
    def initialize(
      ...
      **options
      ...
      @connect_timeout = options.fetch(:connect_timeout, nil).as(Int32 | Float32 | Time::Span | Nil)
      @write_timeout = options.fetch(:write_timeout, nil).as(Int32 | Float32 | Time::Span | Nil)
      @read_timeout = options.fetch(:read_timeout, nil).as(Int32 | Float32 | Time::Span | Nil)
    ...
    private def new_http_client : HTTP::Client
      ...
      client.connect_timeout = @connect_timeout.not_nil! if @connect_timeout
      client.write_timeout = @write_timeout.not_nil! if @write_timeout
      client.read_timeout = @read_timeout.not_nil! if @read_timeout
      client
    end
